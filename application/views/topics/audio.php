	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Play/Download</h3>
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-4">
						<figure>
							<figcaption>Click the three doted icon to download audio file:</figcaption>
							<audio
								controls
								src="<?=base_url($topic->audio)?>">
								...
								<form action="<?=base_url('comments/create_action'); ?>" method="post">
									<div class="input-group">
										<span class="input-group-btn">
											<a href="<?=base_url('audios'); ?>" class="btn btn-default btn-flat" title="Back to scripts"><i class="fa fa-chevron-left"></i></a>
										</span>

										<input type="text" name="comment" id="comment" placeholder="Type Comment ..." class="form-control" required>
										
										<input type="hidden" name="media_type" id="media_type" class="form-control" value="2">
										<input type="hidden" name="media_id" id="media_id" class="form-control" value="<?=$audio_id;?>">
