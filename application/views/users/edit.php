    ...
    <div class="col-md-12">
		...
		<!-- </div> -->
			...
			<!-- 
			 ...
			 <?php echo form_open('users/edit_action'); ?>
			<div class="box-body">
				<!-- <div class="row"> -->
					<div class="col-md-6">
						<label for="username" class="control-label">Username</label>
						<div class="form-group">
							<input type="text" name="username" value="<?=$username; ?>" class="form-control" id="username" disabled />
							<span class="text-danger"><?php echo form_error('username');?></span>
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="email" value="<?=$email; ?>" class="form-control" id="email" disabled />
							<span class="text-danger"><?php echo form_error('email');?></span>
						</div>
					</div>
					<div class="col-md-6">
						<label for="first_name" class="control-label">First Name</label>
						<div class="form-group">
							<input type="text" name="first_name" value="<?=$first_name; ?>" class="form-control" id="first_name" required/>
						</div>
					</div>
					<div class="col-md-6">
						<label for="last_name" class="control-label">Last Name</label>
						<div class="form-group">
							<input type="text" name="last_name" value="<?=$last_name; ?>" class="form-control" id="last_name" required/>
						</div>
					</div>

					<div class="col-md-6">
						<label for="last_name" class="control-label">* Channel</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="job_title" class="control-label">Job Title</label>
						<div class="form-group">
							<input type="text" name="job_title" value="<?=$job_title; ?>" class="form-control" id="job_title" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="employed_on" class="control-label">Employed On</label>
					...
					<div class="col-md-6">
						<label for="dob" class="control-label">DOB</label>
						<div class="form-group">
							<input type="text" name="dob" value="<?=$dob; ?>" class="form-control" id="dob" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="phone" class="control-label">Phone</label>
